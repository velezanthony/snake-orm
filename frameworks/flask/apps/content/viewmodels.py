"""Re-export of the shared content view models, so the routes import from their own layer.

The same seam every other domain makes: a route says `from apps.content import viewmodels` and never
