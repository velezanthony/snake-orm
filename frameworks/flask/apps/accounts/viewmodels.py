"""Re-export of the shared accounts view models, so the routes import from their own layer.

The same seam every other domain makes: a route says `from apps.accounts import viewmodels` and never
