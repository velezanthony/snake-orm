"""Re-export of the shared auth view models, so the routes import from their own layer.

The same seam every other domain makes: a route says `from apps.auth import viewmodels` and never
