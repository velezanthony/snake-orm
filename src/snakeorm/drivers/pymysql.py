...
class PyMySQLDriver:
    ...
    def __init__(self, connection: _Connection) -> None:
        ...
        self._last_insert_id = (
            0  # the id generated by the last INSERT (MySQL has no RETURNING)
        )
    ...
    def execute(self, sql: str, params: Sequence[object]) -> int:
        ...
        It stores `lastrowid` (read BEFORE closing the cursor): without RETURNING that is the only way to recover the generated PK.
        """
        cursor = self._connection.cursor()
        try:
            cursor.execute(
    ...
    def last_insert_id(self) -> int:
        """The autoincrement id of the last INSERT. The session uses it to fill in the PK without RETURNING."""
