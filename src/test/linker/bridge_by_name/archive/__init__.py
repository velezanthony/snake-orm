"""The archive app: its own Tag, Post and Tagging, crossed by NAME."""
...
@snake_model(table="bn_arc_tags", registry=bridge_registry)
...
@snake_model(table="bn_arc_posts", registry=bridge_registry)
...
@snake_model(table="bn_arc_taggings", registry=bridge_registry)
