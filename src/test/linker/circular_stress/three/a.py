"""Link a of the three-module cycle: needs b, which needs the next one, which needs a."""
...
@snake_model(table="stress_three_a", registry=three_registry)
class NodeA(SnakeModel):
    """Points at the next link. No module of the three imports another at runtime."""

    id: SnakeColumn[int] = snake_int(primary_key=True)
    next_id: SnakeColumn[int] = snake_int()
    nxt: SnakeToOne[NodeB] = snake_to_one(next_id)
